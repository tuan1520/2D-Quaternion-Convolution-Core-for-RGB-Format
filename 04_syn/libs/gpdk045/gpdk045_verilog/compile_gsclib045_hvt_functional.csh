...
#               (b) cds.lib file (for define library, Eg: gsclib045_hvt)
#
# Syntax: compile_gsclib045_hvt_functional.csh
#---------------------------------------------------------------------------------
#
set verilogFile = slow_vdd1v0_basicCells_hvt.v
set libName     = gsclib045_hvt
