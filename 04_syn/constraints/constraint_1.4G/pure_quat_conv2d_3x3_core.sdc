...
# Aggressive internal timing check at 1.4GHz
#
# Purpose:
# - Push the design toward a high-frequency target (1.4 GHz)
...
# 1) Clock definition
# ---------------------------------------------------------
# Target clock period = 0.714 ns  =>  1.4 GHz
set CLK_PERIOD 0.714
